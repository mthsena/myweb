...
<head>
    ...
    <meta name='twitter:url' content='<?php echo Path::host(Path::uri()); ?>'>
    ...
    <meta property='og:url' content='<?php echo Path::host(Path::uri()); ?>'>
    <link rel='canonical' href='<?php echo Path::host(Path::uri()); ?>'>
    <link rel='ico' type='image/x-icon' href='<?php echo Path::host('/favicon.ico'); ?>'>
